  ...
  return (
    ...
    >
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse 90% 70% at 50% 50%, color-mix(in oklch, var(--primary) 12%, transparent), transparent 70%), radial-gradient(ellipse 60% 60% at 90% 20%, color-mix(in oklch, var(--primary) 18%, transparent), transparent 65%), radial-gradient(ellipse 60% 60% at 10% 90%, color-mix(in oklch, var(--primary) 14%, transparent), transparent 65%)",
        }}
      />
